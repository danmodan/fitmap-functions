...
public class ObjectMapperConfig {
    ...
    static {
        ...
        DEFAULT_DATE_TIME_FORMATTER = DateTimeFormatter.ISO_OFFSET_DATE_TIME.withZone(ZoneOffset.UTC);
    ...
    private static void configDateTimeModule(ObjectMapper objM) {

        objM.registerModule(createJavaZonedTimeModule());
        objM.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
    }

    private static JavaTimeModule createJavaZonedTimeModule() {
